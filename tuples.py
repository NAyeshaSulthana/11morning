...
a=1,2,3,4,5#() is recommended but not mandatory&by declaring , 
#between them defaults takes tuple
...
a=1,2,3,4,5
print(type(a))
#() is recommended but not mandatory&by declaring , 
#between them defaults takes tuple
a=(1)
print(type(a))
a=1
...
#as tuple immutable,there are no pop()
a=(3,4.5,6,7.1,3,6,8,9,0)
print(a.count(3))
print(a.index(7.1))# finding index
print(a[0])#finding index value
